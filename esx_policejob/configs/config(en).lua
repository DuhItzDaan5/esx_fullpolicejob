...
Config.PoliceStations = {
	...
	SSPD = {
		...
		-- https://wiki.rage.mp/index.php?title=Weapons
		AuthorizedWeapons = {
			{ name = 'WEAPON_NIGHTSTICK', price = 200, ammo = 1, label = "Balton" },
			{ name = 'WEAPON_PISTOL', price = 300, ammo = 30, label = "Walther P99Q"},
			{ name = 'WEAPON_PISTOL', price = 300, ammo = 60, label = "Glock-17"},
			{ name = 'WEAPON_CARBINERIFLE', price = 1250, ammo = 60, label = "M4A1 Carbine" },
			{ name = 'WEAPON_SMG', price = 1250, ammo = 60, label = "MP5" },
			{ name = 'WEAPON_STUNGUN', price = 500, ammo = 30, label = "Taser" },
			{ name = 'WEAPON_FLASHLIGHT', price = 80, ammo = 1, label = "Flashlight" },
			{ name = 'WEAPON_FIREEXTINGUISHER', price = 120, ammo = 4500, label = "Fireextingguisher" },
		},
