Locales['en'] = {
-- I use Dutch EUP so it may be that the outfits look weird  you can turn into the client.lua to change the outfits.
  -- Cloakroom
  ['cloakroom'] = 'Locker Room',
  ['citizen_wear'] = 'Civilian Clothes',
  ['police_wear'] = 'Click here for a HELMET / GLASSES (CUSTOM)',
  ['kortnh_wear'] = 'Officer (CUSTOM)',
  ['langnh_wear'] = 'Officer2 (CUSTOM)',
  ['verkeerkort_wear'] = 'Traffic (CUSTOM)',
  ['verkeerlang_wear'] = 'Traffic2 (CUSTOM)',
  ['ovdpkort_wear'] = 'boss1 (CUSTOM)',
  ['ovdplang_wear'] = 'boss2 (CUSTOM)',
  ['motor_wear'] = 'Motorcycle agent (CUSTOM)',
  ['witpak_wear'] = 'Office Clothes (CUSTOM)',
  ['geelpak_wear'] = 'Traffic3 (CUSTOM)',
  ['gilet_wear'] = 'Police Vest (CUSTOM)',
  ['pet_wear'] = 'Police Cap (CUSTOM)',
  ['unmarked_wear'] = 'Unmarked Uniform (CUSTOM)',
  ['bullet1_wear'] = 'remove vest (CUSTOM)',
  ['bullet_wear'] = 'bulletproof vest(CUSTOM)',
  ['no_outfit'] = 'There is no outfit! (CUSTOM)',
