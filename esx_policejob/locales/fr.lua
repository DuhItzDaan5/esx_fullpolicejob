Locales['fr'] = {
-- J’utilise Dutch EUP de sorte qu’il se peut que les tenues look bizarre, vous pouvez vous transformer en client.lua pour changer les tenues.
  -- Cloakroom
  ['cloakroom'] = 'vestiaire',
  ['citizen_wear'] = 'tenue Civil',
  ['police_wear'] = 'Cliquez ici pour un HELMET / GLASSES (CUSTOM)',
  ['kortnh_wear'] = 'Agent (CUSTOM)',
  ['langnh_wear'] = 'Agent2 (CUSTOM)',
  ['verkeerkort_wear'] = 'Trafic (CUSTOM)',
  ['verkeerlang_wear'] = 'Trafic2 (CUSTOM)',
  ['ovdpkort_wear'] = 'Patron1 (CUSTOM)',
  ['ovdplang_wear'] = 'Patron2 (CUSTOM)',
  ['motor_wear'] = 'Moto agent (CUSTOM)',
  ['witpak_wear'] = 'Vêtements de bureau (CUSTOM)',
  ['geelpak_wear'] = 'Trafic3 (CUSTOM)',
  ['gilet_wear'] = 'Veste de police  (CUSTOM)',
  ['pet_wear'] = 'Casquette de police (CUSTOM)',
  ['unmarked_wear'] = 'Uniforme non marqué (CUSTOM)',
  ['bullet1_wear'] = 'Enlever le gilet (CUSTOM)',
  ['bullet_wear'] = 'gilet pare-balles (CUSTOM)',
  ['no_outfit'] = 'Il n’y a pas de tenue ! (CUSTOM)',
