Locales['de'] = {
-- Ich benutze dutch EUP, so kann es sein, dass die Outfits seltsam aussehen können Sie in die client.lua verwandeln können, um die Outfits zu ändern.
  -- Cloackroom
  ['cloakroom'] = 'Garderobe',
  ['citizen_wear'] = 'Zivilkleidung',
  ['police_wear'] = 'Klicken Sie hier für eine HELMET / GLASSES (CUSTOM)',
  ['kortnh_wear'] = 'Officer (CUSTOM)',
  ['langnh_wear'] = 'Officer2 (CUSTOM)',
  ['verkeerkort_wear'] = 'Verkehr (CUSTOM)',
  ['verkeerlang_wear'] = 'Verkehr2 (CUSTOM)',
  ['ovdpkort_wear'] = 'chef1 (CUSTOM)',
  ['ovdplang_wear'] = 'chef2 (CUSTOM)',
  ['motor_wear'] = 'Motorradagent (CUSTOM)',
  ['witpak_wear'] = 'Bürokleidung (CUSTOM)',
  ['geelpak_wear'] = 'Verkehr3 (CUSTOM)',
  ['gilet_wear'] = 'Polizeiweste (CUSTOM)',
  ['pet_wear'] = 'Police Cap (CUSTOM)',
  ['unmarked_wear'] = 'Unmarkierte Uniform (CUSTOM)',
  ['bullet1_wear'] = 'Weste entfernen (CUSTOM)',
  ['bullet_wear'] = 'kugelsichere Weste (CUSTOM)',
  ['no_outfit'] = 'Es gibt kein Outfit!(CUSTOM)',
  ...
  --Revive
  ['revive player'] = 'wiederbelebung Spieler',
  ['revive_inprogress'] = 'iederbelebung im Gange',
  ['revive_complete'] = 'Wiederbelebung komplett',
  ['isdead'] = 'Player Dead',
  -- Traffic interaction
